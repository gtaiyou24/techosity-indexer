...
class Blog:
    ...
    def __init__(self, blog_id: BlogId, blog_title: BlogTitle,
                 blog_description: BlogDescription, blog_url: URL):
        ...
        assert blog_url is not None, "引数urlにNoneが指定されています。引数urlは必須です。"
        ...
        assert isinstance(blog_url, URL), "引数urlに{}が指定されています。URL型を指定して下さい。".format(type(blog_url))
        ...
        super().__setattr__("blog_url", blog_url)
